...
variable "environment" {
  description = "The environment to deploy (dev, test, uat, prod)"
  type        = string
}

variable "location_se" {
  description = "The Azure region to deploy resources in Southeast Asia"
  type        = string
}

variable "location_br" {
  description = "The Azure region to deploy resources in Brazil South"
  type        = string
}
